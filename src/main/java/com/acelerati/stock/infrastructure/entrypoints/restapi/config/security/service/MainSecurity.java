...
import com.acelerati.stock.infrastructure.entrypoints.restapi.config.security.jwt.JwtEntryPoint;
import com.acelerati.stock.infrastructure.entrypoints.restapi.config.security.jwt.JwtTokenFilter;
...
public class MainSecurity extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.cors().and().csrf().disable()
                ...
                .and()
                .exceptionHandling().authenticationEntryPoint((AuthenticationEntryPoint) jwtEntryPoint)
                .and()
